...
function addItems() {
  ...
  createItem(215, 150, 'coin');
  createItem(625, 100, 'coin');
  createItem(450, 150, 'coin');
  createItem(370, 600, 'poison');
...
window.onload = function () {
  ...
  function preload() {
    ...
    //Load spritesheets
    game.load.spritesheet('player', 'realjustin.png', 48, 62);
  ...
  function create() {
    ...
    text = game.add.text(16, 16, "SCORE: " + currentScore, { font: "bold 24px Arial", fill: "black" });
    winningMessage = game.add.text(game.world.centerX, 275, "", { font: "bold 48px Arial", fill: "blue" });
  ...
  function update() {
    ...
    // when Justin wins the game
    if (won) {
      winningMessage.text = "Justin dominates again!!";
    }
  }
